...
namespace fluff { namespace gfx {
	...
	public:
		...
		*/
		FLUFF_API FrameBuffer(std::shared_ptr<ECSManager> Manager, uint32_t Width, uint32_t Height);
		...
		*/
		FLUFF_API FrameBuffer(std::shared_ptr<ECSManager> Manager, uint32_t Width, uint32_t Height, uint32_t Depth);

		FLUFF_API ~FrameBuffer() { Release(); }
		...
		*/
		void FLUFF_API Bind(ACTION Action) const;

		/*
			Unbinds the framebuffer
		*/
		void FLUFF_API Unbind() const;
		...
		*/
		void FLUFF_API Unbind(uint32_t Width, uint32_t Height) const;
		...
		*/
		void FLUFF_API Resize(uint32_t Width, uint32_t Height);
		...
		*/
		...
		/*
			...
			Returns depth ID
		*/
		int32_t FLUFF_API AddDepthTexture();
		...
		/* 
			...
			Returns ID
		*/
		int32_t FLUFF_API AddDepthTexture(uint32_t ID);
		...
		*/
		...
		/*
			...
			Returns ID
		*/
		int32_t FLUFF_API AddDepthBuffer();
		...
		*/
		...
		/*
			...
			Returns texture IDs
		*/
		inline std::vector<uint32_t*> GetTextureIDs()
		{
		...
		*/
		inline uint32_t * GetDepthID() { return &DepthTexture_;  }
		...
		*/
		void FLUFF_API SetDrawBuffers(uint32_t * IDs, uint32_t Count) const;
		...
		*/
		void FLUFF_API DrawToScreen(uint32_t Width, uint32_t Height) const;
	};
